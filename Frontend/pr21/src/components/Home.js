...
class Home extends Component {
    ...
    handleTrainChange = event => {
        ...
        axios.post('https://'+window.address+':8000/convertFile', formdata, { headers: { 'Accept': 'multipart/form-data', 'Content-Type': 'multipart/form-data' } })
            .then((response) => {
    ...
    handleSubmit = event => {
        ...
        axios.post('https://'+window.address+':8000/create', formdata, { headers: { 'Accept': 'multipart/form-data', 'Content-Type': 'multipart/form-data' } })
            .then((res) => {
    ...
    handleManual = event => {
        ...
        axios.get('https://'+window.address+':8000/getPreprocessParam')
            .then((response) => {
    ...
    handleSubmit2 = event => {
        ...
        setTimeout(() => {
            ...
            axios.post('https://'+window.address+':8000/auto', JSON.stringify(data))
                .then(res => {
    ...
    handleSubmitTime = event => {
        ...
        setTimeout(() => {
            ...
            axios.post('https://'+window.address+':8000/timeseries', JSON.stringify(data))
                .then(res => {
