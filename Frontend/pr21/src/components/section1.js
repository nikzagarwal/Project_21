        ...
        return (
            <div className="section1">
                <div className="container typing-text">
                    ...
                    <div className="section1text1">Auto Ml is latest and advanced way to simplify artificial intelligence usage for people who are not into coding but still want to experience the magic</div>
